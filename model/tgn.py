...
from utils.utils import MergeLayer, process_sampling_numbers
...
class TGN(torch.nn.Module):
  def __init__(self, neighbor_finder, node_features, edge_features, device, n_layers=2,
    ...
    if not self.ignore_caw:
        ...
        self.caw_neighbors, self.caw_layers = process_sampling_numbers(caw_neighbors, caw_layers)
